...
export default function SsgBrowserTimes() {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          The payload is already baked into the HTML before the request starts.
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter>
        <p className="text-sm leading-relaxed text-muted-foreground">
          For SSG, the browser still measures receive and hydration time, but
          the payload itself was created before deploy/runtime.
        </p>
      </CardFooter>
    </Card>
  );
